...
Partial Class GF_mktSalesPersons
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/MKT_Main/App_Display/DF_mktSalesPersons.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?SerialNo=" & aVal(0) & "&SalesPerson=" & aVal(1)
  ...
  Protected Sub GVmktSalesPersons_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVmktSalesPersons.Init
    DataClassName = "GmktSalesPersons"
    SetGridView = GVmktSalesPersons
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptSerialNo As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_MKT_SalesPersons_SerialNo_main = true;" & _
      "    validate_FK_MKT_SalesPersons_SerialNo(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_MKT_SalesPersons_SerialNo As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_MKT_SalesPersons_SerialNo(o) {" & _
      "    var value = o.id;" & _
      "    var SerialNo = $get('" & F_SerialNo.ClientID & "');" & _
      "    try{" & _
      "    if(SerialNo.value==''){" & _
      "      if(validated_FK_MKT_SalesPersons_SerialNo.main){" & _
      ...
      "    PageMethods.validate_FK_MKT_SalesPersons_SerialNo(value, validated_FK_MKT_SalesPersons_SerialNo);" & _
      "  }" & _
      "  validated_FK_MKT_SalesPersons_SerialNo_main = false;" & _
      "  function validated_FK_MKT_SalesPersons_SerialNo(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_MKT_SalesPersons_SerialNo") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_MKT_SalesPersons_SerialNo", validateScriptFK_MKT_SalesPersons_SerialNo)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
